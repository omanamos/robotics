...
estimateSurfaceNormals (const PointCloudPtr & input, float radius)
{
  ...
  normal_estimation.setSearchMethod (pcl::KdTreeFLANN<PointT>::Ptr (new pcl::KdTreeFLANN<PointT>));
                         ...
                         const PointCloudPtr & keypoints, float feature_radius)
{
  ...
  fpfh_estimation.setSearchMethod (pcl::KdTreeFLANN<PointT>::Ptr (new pcl::KdTreeFLANN<PointT>));
...
computeGlobalDescriptor (const PointCloudPtr & points, const SurfaceNormalsPtr & normals)
{
  ...
  vfh_estimation.setSearchMethod (pcl::KdTreeFLANN<PointT>::Ptr (new pcl::KdTreeFLANN<PointT>));
