...
template <>
  const int32_t TBinaryProtocolT<apache::thrift::transport::TTransport>::VERSION_MASK = 0xffff0000;
template <>
  const int32_t TBinaryProtocolT<apache::thrift::transport::TTransport>::VERSION_1 = 0x80010000;
